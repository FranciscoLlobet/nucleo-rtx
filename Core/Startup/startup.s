/**
  * STM32G474xx startup file compatible with picolibc
  */
...
/* Make symbols compatible with picolibc */
.global	__interrupt_vector     /* Changed from g_pfnVectors */
.global	Default_Handler

/* Picolibc-compatible symbol names */
.word	__data_source
.word	__data_start
.word	__data_end
.word	__bss_start
...
/******************************************************************************
* Vector table - MUST be named __interrupt_vector for picolibc
******************************************************************************/
...
__interrupt_vector:
	.word	__stack
	.word	_start                /* Use _start instead of Reset_Handler */
	.word	NMI_Handler
	...
	.word	TIM7_DAC_IRQHandler      /* This is your TIM7 handler */
...
/**
 * SystemInit - called by picolibc before main
 */
    .section	.text.SystemInit,"ax",%progbits
	.weak	SystemInit
	.type	SystemInit, %function
SystemInit:
	/* Your system initialization code here */
	/* Clock setup, etc. */
	bx	lr
...
* IMPORTANT: These will be overridden by strong symbols in your code
*******************************************************************************/
