...
const ARM_MPU_Region_t mpu_table[4][8] = {
		...
		/* Flash Memory as RO */
			...
			{.RBAR = ARM_MPU_RBAR(1, SRAM_BASE_ADDRESS),  .RASR = ARM_MPU_RASR_EX(0, ARM_MPU_AP_FULL, ARM_MPU_ACCESS_NORMAL(ARM_MPU_CACHEP_NOCACHE, ARM_MPU_CACHEP_NOCACHE, 1), 0x00, ARM_MPU_REGION_SIZE_128KB)},
			/* Peripheral Base Address */
			{.RBAR = ARM_MPU_RBAR(2, PERIPHERAL_BASE_ADDRESS), .RASR = ARM_MPU_RASR_EX(0, ARM_MPU_AP_FULL, ARM_MPU_ACCESS_NORMAL(ARM_MPU_CACHEP_NOCACHE, ARM_MPU_CACHEP_NOCACHE, 1), 0x00, ARM_MPU_REGION_SIZE_4GB)},
